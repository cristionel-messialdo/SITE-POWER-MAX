        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                name: 'João Silva',
                text: 'Excelente qualidade dos produtos e entrega super rápida. Recomendo!',
                rating: 5
              },
              {
                name: 'Maria Santos',
                text: 'A melhor loja de suplementos que já comprei. Produtos originais e preços justos.',
                rating: 5
              },
              {
                name: 'Pedro Costa',
                text: 'Atendimento excepcional e produtos de primeira linha. Virei cliente fiel!',
                rating: 5
              }
